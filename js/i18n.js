...
const I18N = {
    ...
    dict: {
        en: {
            ...
            'cmd-open-desc': 'Open a new window (about, projects)',
            'cmd-jackin-desc': '???',
            'cmd-2077-desc': '???',
            'cmd-glitch-desc': 'Trigger full-screen glitch effect',
            'cmd-glitch-active': 'Reality destabilized.',
            ...
            // --- Card Flip ---
            'card-flip-close': 'CLOSE',
            'prj-1-desc-long': 'AI-powered neural network visualization platform with real-time training metrics monitoring and 3D model architecture rendering. Features include dynamic weight visualization, gradient flow tracking, and interactive layer inspection.',
            'prj-1-feat-1': 'Real-time 3D rendering',
            'prj-1-feat-2': 'Live training metrics',
            'prj-1-feat-3': 'Interactive layer inspector',
            'prj-2-desc-long': 'Real-time data dashboard with WebSocket streaming, particle effects, and holographic UI components inspired by sci-fi interfaces. Built with a modular widget system for customizable layouts.',
            'prj-2-feat-1': 'WebSocket streaming',
            'prj-2-feat-2': 'Holographic UI widgets',
            'prj-2-feat-3': 'Custom layout engine',
            'prj-3-desc-long': 'Decentralized storage protocol with end-to-end encryption, zero-knowledge proofs, and a stunning glassmorphism interface. Supports file sharding, redundancy, and on-chain verification.',
            'prj-3-feat-1': 'End-to-end encryption',
            'prj-3-feat-2': 'Zero-knowledge proofs',
            'prj-3-feat-3': 'On-chain verification',
            'prj-4-desc-long': 'Generative art studio that creates unique digital artworks using procedural algorithms, fluid simulations, and shader magic. Export to SVG, PNG, or GLTF for further processing.',
            'prj-4-feat-1': 'Fluid simulation engine',
            'prj-4-feat-2': 'GLSL shader pipeline',
            'prj-4-feat-3': 'Multi-format export',
            'prj-5-desc-long': 'Privacy-first messaging app with quantum-resistant encryption, self-destructing messages, and a brutalist cyberpunk UI. Messages evaporate after reading — no logs, no traces.',
            'prj-5-feat-1': 'Quantum-resistant crypto',
            'prj-5-feat-2': 'Self-destructing messages',
            'prj-5-feat-3': 'Zero-log architecture',
            'prj-6-desc-long': 'Conversational AI interface with voice synthesis, real-time emotion analysis, and a holographic 3D avatar that responds to user input. Supports multi-turn context and personality adaptation.',
            'prj-6-feat-1': 'Voice synthesis (TTS)',
            'prj-6-feat-2': 'Emotion analysis',
            'prj-6-feat-3': '3D holographic avatar',
        ...
        zh: {
            ...
            'cmd-open-desc': '打开新窗口 (about, projects)',
            'cmd-jackin-desc': '???',
            'cmd-2077-desc': '???',
            'cmd-glitch-desc': '触发全屏故障效果',
            'cmd-glitch-active': '现实已失稳。',
            ...
            // --- Card Flip ---
            'card-flip-close': '关闭',
            'prj-1-desc-long': 'AI驱动的神经网络可视化平台，支持实时训练指标监控和3D模型架构渲染。包含动态权重可视化、梯度流追踪和交互式层级检查功能。',
            'prj-1-feat-1': '实时3D渲染',
            'prj-1-feat-2': '训练指标监控',
            'prj-1-feat-3': '交互式层级检查器',
            'prj-2-desc-long': '实时数据仪表盘，集成WebSocket流式传输、粒子特效和全息UI组件，灵感来自科幻界面。采用模块化小部件系统，支持自定义布局。',
            'prj-2-feat-1': 'WebSocket流式传输',
            'prj-2-feat-2': '全息UI组件',
            'prj-2-feat-3': '自定义布局引擎',
            'prj-3-desc-long': '去中心化存储协议，端到端加密、零知识证明，配以炫目的毛玻璃风格界面。支持文件分片、冗余存储和链上验证。',
            'prj-3-feat-1': '端到端加密',
            'prj-3-feat-2': '零知识证明',
            'prj-3-feat-3': '链上验证',
            'prj-4-desc-long': '生成艺术工作室，利用程序化算法、流体模拟和着色器魔法创造独特的数字艺术作品。支持导出SVG、PNG或GLTF格式进行后续处理。',
            'prj-4-feat-1': '流体模拟引擎',
            'prj-4-feat-2': 'GLSL着色器管线',
            'prj-4-feat-3': '多格式导出',
            'prj-5-desc-long': '隐私优先的通讯应用，量子抗性加密、自毁消息，搭配粗野主义赛博朋克UI。消息阅后即焚——不留日志，不留痕迹。',
            'prj-5-feat-1': '量子抗性加密',
            'prj-5-feat-2': '消息自毁机制',
            'prj-5-feat-3': '零日志架构',
            'prj-6-desc-long': '对话式AI界面，集成语音合成、实时情绪分析，全息3D形象根据用户输入做出反应。支持多轮上下文记忆和人格自适应。',
            'prj-6-feat-1': '语音合成 (TTS)',
            'prj-6-feat-2': '实时情绪分析',
            'prj-6-feat-3': '3D全息形象',
